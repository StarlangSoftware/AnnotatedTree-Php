...
class IsDoubleNode implements NodeDrawableCondition
{
     ...
     * @return bool True if the tag of the parse node is equal to the tag of its child node, false otherwise.
     */
