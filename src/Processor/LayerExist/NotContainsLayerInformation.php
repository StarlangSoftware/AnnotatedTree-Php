...
class NotContainsLayerInformation implements LeafListCondition
{
     ...
     * @return bool True if none of the leaf nodes in the leafList contains the given layer information, false otherwise.
     */
